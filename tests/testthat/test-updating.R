...
test_that("updating", {
    ...
    expect_message(UpdateEvery(60, units = "minutes"), message("R output expires in 3600 seconds with wakeup"))
    expect_message(UpdateEvery(2, units = "weeks"), message("R output expires in 1209600 seconds with wakeup"))
